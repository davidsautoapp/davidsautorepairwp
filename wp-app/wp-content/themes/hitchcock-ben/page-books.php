...
if ( have_posts() ) : 
	...
	while( have_posts() ) : the_post(); ?>
		...
		<div class="content section-inner books-pg">
...
<div class="content section-inner">
	...
	<div class="posts group" id="posts">
      ...
      'order'           =>  'ASC'
        ...
        <a href="<?php the_permalink() ?>" id="post-59" class="post post-59 hb_book type-hb_book status-publish hentry hb_book_type-authors _hb">
