...
echo do_shortcode('[slide-anything id="7"]');
			...
			<div id="post-<?php the_ID(); ?>" <?php post_class( 'single single-post' ); ?>>
				...
				<div class="post-container">
					...
					<div class="post-header">
						...
						<h1 class="post-title" style="text-align: center;">Harlem Book Center</h1>
...
<?php include_once('book-selection.php'); 
book_selection("Books", 8);
?>
...
<div class="content section-inner">
	...
	<header class="archive-header">
		<h2 class="archive-title">Portfolio</h2>
		<div class="archive-description"><p><a href="<?php site_url('/portfolio') ?>">Learn more...</a></p>
		</div>
